...
#for showing signup/login button for admin(by akkig)
...
#for showing signup/login button for doctor(by akkig)
...
#for showing signup/login button for patient(by akkig)
...
#-----------for checking user is doctor , patient or admin(by akkig)
def is_admin(user):
